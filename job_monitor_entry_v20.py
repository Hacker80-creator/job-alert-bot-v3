"""Production entry point with verified first and second career-link batches."""
...
import custom_source_parsers_v11
...
OVERRIDES_FILE = ROOT / "source_overrides_v18.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v19.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v11.fetch_company_jobs_with_custom_v11
