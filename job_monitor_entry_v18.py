"""Production entry point with resume-aware matching and expanded source coverage."""
...
import custom_source_parsers_v9
...
OVERRIDES_FILE = ROOT / "source_overrides_v16.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v17.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v9.fetch_company_jobs_with_custom_v9
