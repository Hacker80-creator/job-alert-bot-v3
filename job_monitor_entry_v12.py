"""Final production entry point for all verified matching and source repairs."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v10.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v11.load_final_config()
