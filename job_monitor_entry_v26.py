"""Production entry point with Param.ai, Dayforce, and TurboHire sources."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v24.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v25.load_final_config()
