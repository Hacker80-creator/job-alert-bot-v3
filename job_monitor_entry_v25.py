"""Production entry point with the second dynamic ATS source batch."""
...
import custom_source_parsers_v16
...
OVERRIDES_FILE = ROOT / "source_overrides_v23.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v24.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v16.fetch_company_jobs_with_custom_v16
