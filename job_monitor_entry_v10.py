"""Final production entry point with bounded Tavant newest-job scanning."""
...
import custom_source_parsers_v3
...
OVERRIDES_FILE = ROOT / "source_overrides_v8.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v9.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v3.fetch_company_jobs_with_custom_v3
