"""Production entry point with four additional first-party careers boards."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v41.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v42.load_final_config()
