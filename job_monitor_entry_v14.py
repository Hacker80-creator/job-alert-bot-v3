"""Production entry point with IQVIA's current faceted Workday source."""
...
import custom_source_parsers_v6
...
OVERRIDES_FILE = ROOT / "source_overrides_v12.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v13.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v6.fetch_company_jobs_with_custom_v6
