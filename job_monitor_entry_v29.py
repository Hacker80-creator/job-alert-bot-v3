"""Production entry point with monday.com and FullStory Ashby monitoring."""
...
import custom_source_parsers_v18
...
OVERRIDES_FILE = ROOT / "source_overrides_v27.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v28.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v18.fetch_company_jobs_with_custom_v18
