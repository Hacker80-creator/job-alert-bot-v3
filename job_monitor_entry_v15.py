"""Final production entry point with complete IQVIA Bangalore coverage."""
...
import custom_source_parsers_v7
...
OVERRIDES_FILE = ROOT / "source_overrides_v13.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v14.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v7.fetch_company_jobs_with_custom_v7
