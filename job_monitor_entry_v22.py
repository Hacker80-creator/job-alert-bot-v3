"""Production entry point with repaired first-party zero-result sources."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v20.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v21.load_final_config()
