"""Final production entry point with Expedia's official sitemap feed."""
...
import custom_source_parsers_v8
...
OVERRIDES_FILE = ROOT / "source_overrides_v14.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v15.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v8.fetch_company_jobs_with_custom_v8
