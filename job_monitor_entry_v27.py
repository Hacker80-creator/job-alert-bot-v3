"""Production entry point with the verified Workday and Greenhouse batch."""
...
import custom_source_parsers_v17
...
OVERRIDES_FILE = ROOT / "source_overrides_v25.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v26.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v17.fetch_company_jobs_with_custom_v17
