"""Final production entry point with Tavant transport compatibility."""
...
import custom_source_parsers_v4
...
OVERRIDES_FILE = ROOT / "source_overrides_v9.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v10.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v4.fetch_company_jobs_with_custom_v4
