"""Production entry point with Rupeek, Sahaj, and Times Internet."""
...
import custom_source_parsers_v27
...
OVERRIDES_FILE = ROOT / "source_overrides_v39.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v40.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v27.fetch_company_jobs_with_custom_v27
