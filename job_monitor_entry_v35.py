"""Production entry point with recovered Zwayam and Keka boards."""
...
import custom_source_parsers_v21
...
OVERRIDES_FILE = ROOT / "source_overrides_v33.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v34.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v21.fetch_company_jobs_with_custom_v21
