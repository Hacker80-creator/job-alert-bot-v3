"""Production entry point with recovered RippleHire and Zoho boards."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v32.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v33.load_final_config()
