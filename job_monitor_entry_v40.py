"""Production entry point with WebEngage, Yulu, Ultraviolette, and Kissflow."""
...
import custom_source_parsers_v26
...
OVERRIDES_FILE = ROOT / "source_overrides_v38.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v39.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v26.fetch_company_jobs_with_custom_v26
