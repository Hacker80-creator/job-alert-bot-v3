"""Final production entry point with precision matching and resilient sources."""
...
import custom_source_parsers_v2
...
OVERRIDES_FILE = ROOT / "source_overrides_v6.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v7.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v2.fetch_company_jobs_with_custom_v2
