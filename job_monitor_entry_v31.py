"""Production entry point with sitemap and recovered parent-board monitoring."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v29.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v30.load_final_config()
