"""Production entry point with Deel and Gem boards."""
...
import custom_source_parsers_v22
...
OVERRIDES_FILE = ROOT / "source_overrides_v34.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v35.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v22.fetch_company_jobs_with_custom_v22
