"""Production entry point with MediaTek and Nagarro first-party feeds."""
...
import custom_source_parsers_v28
...
OVERRIDES_FILE = ROOT / "source_overrides_v40.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v41.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v28.fetch_company_jobs_with_custom_v28
