"""Production entry point with structured listing and Trakstar monitors."""
...
import custom_source_parsers_v20
...
OVERRIDES_FILE = ROOT / "source_overrides_v31.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v32.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v20.fetch_company_jobs_with_custom_v20
