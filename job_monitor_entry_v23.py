"""Production entry point with recovered official career sources and aliases."""
...
import custom_source_parsers_v14
...
OVERRIDES_FILE = ROOT / "source_overrides_v21.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v22.load_final_config()
    document = yaml.safe_load(OVERRIDES_FILE.read_text(encoding="utf-8")) or {}
    return job_monitor_entry_v2.apply_overrides(
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v14.fetch_company_jobs_with_custom_v14
