"""Production entry point with first-party and Skima career pages."""
...
import custom_source_parsers_v24
...
OVERRIDES_FILE = ROOT / "source_overrides_v36.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v37.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v24.fetch_company_jobs_with_custom_v24
