"""Production entry point with Goldman Sachs Higher and Infineon Eightfold."""
...
import custom_source_parsers_v23
...
OVERRIDES_FILE = ROOT / "source_overrides_v35.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v36.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v23.fetch_company_jobs_with_custom_v23
