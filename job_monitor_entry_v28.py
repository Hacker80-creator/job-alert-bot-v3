"""Production entry point with Enphase and Pegasystems public sources."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v26.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v27.load_final_config()
