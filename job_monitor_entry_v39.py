"""Production entry point with Urban Company, ShareChat, River, and Scrut."""
...
import custom_source_parsers_v25
...
OVERRIDES_FILE = ROOT / "source_overrides_v37.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v38.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v25.fetch_company_jobs_with_custom_v25
