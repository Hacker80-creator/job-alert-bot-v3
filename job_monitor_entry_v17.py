"""Final production entry point with the August stale-source repair batch."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v15.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v16.load_final_config()
