"""Production entry point with repaired Atlassian and Chargebee sources."""
...
import custom_source_parsers_v10
...
OVERRIDES_FILE = ROOT / "source_overrides_v17.yaml"
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v10.fetch_company_jobs_with_custom_v10
