"""Production entry point with shared Avature dynamic-source support."""
...
import custom_source_parsers_v15
...
OVERRIDES_FILE = ROOT / "source_overrides_v22.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v23.load_final_config()
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v15.fetch_company_jobs_with_custom_v15
