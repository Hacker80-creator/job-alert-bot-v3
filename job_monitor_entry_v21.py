"""Production entry point with reviewed runtime-proven career sources."""
...
import custom_source_parsers_v13
...
OVERRIDES_FILE = ROOT / "source_overrides_v19.yaml"
...
if __name__ == "__main__":
    ...
    bot.fetch_company_jobs = custom_source_parsers_v13.fetch_company_jobs_with_custom_v13
