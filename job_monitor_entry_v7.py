"""Production entry point: precise adjacent matching and Microsoft repair."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v5.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v6.load_production_config()
