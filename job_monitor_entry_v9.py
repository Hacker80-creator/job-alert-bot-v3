"""Production entry point with the third stale-source repair batch."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v7.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v8.load_final_config()
