"""Production entry point with the next verified dynamic-source batch."""
...
OVERRIDES_FILE = ROOT / "source_overrides_v28.yaml"


def load_final_config() -> dict:
    config = job_monitor_entry_v29.load_final_config()
